...
<script runat="server">
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        HyperLinkPageNum.NavigateUrl = "~/image/" & m_RoutIFace_Pagenum & "/"
        ...
        Page.Title = mytitle & "- Page " & RoutIFace_Pagenum
                    ...
                    <ul class="list-inline m-0  float-left">
                        ...
                        <li class="list-inline-item">
                            <h5 class="card-title m-0 ">
                                <asp:HyperLink ID="HyperLinkPageNum" runat="server"></asp:HyperLink></h5>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="card-body">
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSourceImage" ConnectionString='<%$ ConnectionStrings:AppConnectionString %>' OnSelected="SqlDataSourceImage_Selected"
                    SelectCommand="SELECT Ti.*, CONVERT(VARCHAR(19), TI.postdate, 120) AS PostDatef, tu.userid, tu.username, tu.routusername 
                        ...
                        WHERE ([STATUS] = 'Visible') ORDER BY [PostDate] DESC"></asp:SqlDataSource>
            </div>
