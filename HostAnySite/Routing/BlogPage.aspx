    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        If IsPostBack = False Then
            If Val(RoutIFace_Pagenum) <= 0 Then
                RoutIFace_Pagenum = 1
            End If
            DataPagerBlog.SetPageProperties((RoutIFace_Pagenum * DataPagerBlog.PageSize) - DataPagerBlog.PageSize, DataPagerBlog.PageSize, True)

            PagingControl.CurrentPage = RoutIFace_Pagenum
            PagingControl.BaseURL = "~/blog/"
        End If

        Title = WebAppSettings.WebSiteName & " Blogs - page " & RoutIFace_Pagenum
        MetaDescription = "Want to start a blog? If so, you are in the right place, Share your blog with sayzz.com members."
            ...
            <div class="card mt-2 BoxEffect6 ">
                <div class="card-header clearfix ">
                    ...
                    <h5 class="card-title m-0 ">
                        <i class="fab fa-blogger"></i>&nbsp;<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Blog/">Recent Blogs</asp:HyperLink>
                    </h5>
                </div>
            </div>
