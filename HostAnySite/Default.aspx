             ...
             <asp:panel runat ="server" ID="PanelHomeBlog" cssclass="panel panel-default ">
                ...
                <div class="panel-body">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 thumb">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-footer clearfix ">
                                        <div class="pull-left">
                                            <small>
                                                <asp:HyperLink ID="Hyperuser" runat="server" CssClass="text-capitalize " Text='<%# Eval("Username")%>' NavigateUrl='<%#"~/User/" + Eval("Routusername").Trim + "/"%>'></asp:HyperLink>
                                                <br />
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSourceBlog" ConnectionString='<%$ ConnectionStrings:AppConnectionString %>'
                        SelectCommand="SELECT t.Blogid, t.Heading, replace(t.[Heading],' ','-') as [Heading2], t.Highlight, t.Containt, CONVERT(VARCHAR(19), t.postdate, 120) AS postdate, t2.username, t2.routusername, t1.ImageFileName as PostImageFilename, t.imageid  
                        FROM [Table_Blog] t
