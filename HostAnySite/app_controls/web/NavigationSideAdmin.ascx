    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#FC-sidebar-navbar-collapse">
                ...
                <asp:HyperLink ID="HyperLink4" NavigateUrl="~/adminPanel/" CssClass ="navbar-brand visible-xs" runat="server"><i class="fa fa-user-secret" aria-hidden="true"></i>&nbsp;Admin Panel</asp:HyperLink>
        ...
        <div class="navbar-collapse collapse" id="FC-sidebar-navbar-collapse" style="padding: 0px;">
            <div class="list-group panel-default" style="margin: 0px;">
                <div class="hidden-xs list-group-item">
                    <strong><asp:HyperLink ID="HyperLink8" NavigateUrl="~/adminPanel/" runat="server"><i class="fa fa-user-secret" aria-hidden="true"></i>&nbsp;Admin Panel</asp:HyperLink></strong>
                </div>
            </div>


            <a href="#User" class="list-group-item Change-DropDown-Icon" data-toggle="collapse" data-parent="#MainMenu"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;User<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
            ...
            <a href="#Blog" class="list-group-item Change-DropDown-Icon" data-toggle="collapse" data-parent="#MainMenu"><i class="fa fa-book" aria-hidden="true"></i>&nbsp;Blog<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
            ...
            <a href="#Setting" class="list-group-item Change-DropDown-Icon" data-toggle="collapse" data-parent="#MainMenu"><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;Setting<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
            <div class="collapse" id="Setting" style ="padding-left :10px">
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="list-group-item" NavigateUrl="~/AdminPanel/Setting/text.aspx"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>&nbsp;Text</asp:HyperLink>
                <asp:HyperLink ID="HyperLink3" runat="server" CssClass="list-group-item" NavigateUrl="~/AdminPanel/Setting/image.aspx"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>&nbsp;Images</asp:HyperLink>
                <asp:HyperLink ID="HyperLink5" runat="server" CssClass="list-group-item" NavigateUrl="~/AdminPanel/Setting/Defaultimage.aspx"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>&nbsp;Default Pictures</asp:HyperLink>
