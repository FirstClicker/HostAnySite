    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
            ...
            <span class="visible-xs navbar-brand">
                <asp:HyperLink ID="HyperLink7" NavigateUrl="~/Dashboard/" runat="server"><i class="fa fa-dashboard" aria-hidden="true"></i>&nbsp;Dashboard</asp:HyperLink>
            </span>
        </div>
        ...
        <div class="navbar-collapse collapse" id="FC-sidebar-navbar-collapse" style="padding: 0px;">
            <div class="list-group panel-default" style="margin: 0px;">
                ...
                <a href="#Blog" class="list-group-item Change-DropDown-Icon" data-toggle="collapse" data-parent="#MainMenu"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Blog Board<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
                ...
                <a href="#Forum" class="list-group-item Change-DropDown-Icon" data-toggle="collapse" data-parent="#MainMenu"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Forum Board<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
