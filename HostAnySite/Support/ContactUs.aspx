...
<%@ Register Src="~/App_Controls/ContactUs.ascx" TagPrefix="uc1" TagName="ContactUs" %>
...
<script runat="server">
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        pageinfo = FirstClickerService.Version1.StaticPage.StaticPage_Get(FirstClickerService.Version1.StaticPage.PageNameList.Site_Support_ContactUs, WebAppSettings.DBCS)
                    ...
                    <ul class="list-inline m-0 ">
                        ...
                        <li class="list-inline-item">
                            <h5 class="card-title m-0 ">
                                <asp:HyperLink ID="HyperLinkKeyword" runat="server" >Contact Us</asp:HyperLink></h5>
                        </li>
                    </ul>
                </div>
            </div>
