...
<script runat="server">
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        pageinfo = FirstClickerService.Version1.StaticPage.StaticPage_Get(FirstClickerService.Version1.StaticPage.PageNameList.Site_Support_Privacy, WebAppSettings.DBCS)
                    ...
                    <ul class="list-inline m-0 ">
                        ...
                        <li class="list-inline-item">
                            <h5 class="card-title m-0 ">
                                <asp:HyperLink ID="HyperLinkKeyword" runat="server" NavigateUrl="~/Support/Privacy.aspx">Privacy</asp:HyperLink></h5>
                        </li>
                    </ul>
                </div>
            </div>
